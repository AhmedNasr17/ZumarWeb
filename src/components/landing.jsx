                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="feature text-center">
                                    <div>
                                        <h5 className="title-landing">Reasones to Buy Zumar</h5>
                                        <p className="pb-3">Zumar HTML template is an apparently simple but highly
                        ...
                        <div className="row feature_row">
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Zumar is a clean and morfern responsive template.it will perfectly suit for any type of online store</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Zumar has powerful backend admin panel to manage products, sales, discount coupons, orders, user, vendor and much more.</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Zumar comes with 4 email template which include two order success template & two email template</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Zumar provides multiple portfolio pages which includes 3 grid view & 4 masonary view.</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                            ...
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Design your website LTR or RTL , Zumar supports multi-languages so its easy to design website on any layout such as arabic , urdu..</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pages/auth/individual-information`} target="_blank">
                                                <img src={`${process.env.PUBLIC_URL}/assets/images/landing-page/special features/other/5.jpg`}
                                                    className="img-fluid lazyload" />
                                            </Link>
                                            <h3>register</h3>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-4 offset-md-1 text-center center-part">
                                ...
                                <p className="pb-3">Zumar come with 4+ email template which include two order
